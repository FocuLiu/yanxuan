<template>
  ...
  <div class="personWrap">
    <div v-if="showTitle" class="title">
      <a class="home" @click="toHome" href="javascript:;"></a>
      <i></i>
      <div class="group">
        <a class="search" href="javascript:;"></a>
        <a class="shopCart" href="javascript:;"></a>
      </div>
    </div>
    <Login v-if="showLogin"></Login>
    <div v-if="!showLogin" class="loginMethodWrap">
      <div class="logWrap">
        <div class="log">
          <img src="../../assets/images/yanxuan.png" alt="">
        </div>
      </div>
      <div class="btnWrap">
        <div class="login phone" @click="toPhone , showLogin = true"><span>手机号码登陆</span></div>
        <div class="login mail"><span>邮箱账号登陆</span></div>
        <div class="register"><span>手机号快捷注册</span><i></i></div>
      </div>
      <div class="thirdWrap">
        <span>
          <i class="weixin"></i>
  ...
  .personWrap
    ...
    .title
      ...
      .home
        ...
        background-image url("../../assets/images/common_icon.png")
        height 24*2px
        width 24*2px
      ...
      i
        ...
        width 86*2px
        background-image url("../../assets/images/common_icon.png")
        background-position 0 -64.0343*2px
        background-repeat no-repeat
        margin auto
      .group
        display flex
    ...
    .btnWrap
      ...
      .register
        ...
        i
          ...
          width 28px
          background-repeat no-repeat
          background url("http://yanxuan-static.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/icon-normal/arrow-right3-8d47138d73.png")
